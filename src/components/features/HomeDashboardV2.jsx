    ...
    const actionItems = [
        {
            ...
            label: 'Approve Shift Swap — Omar Jabri',
        },
        {
            icon: <EvaluationIcon sx={{ fontSize: 18 }} />,
            iconColor: C.purple,
            iconBg: `${C.purple}12`,
            chip: 'PMP',
            chipColor: C.purple,
            chipBg: `${C.purple}12`,
            action: () => onAction?.('evaluations'),
            label: 'Complete Q1 Performance Evaluation',
        },
        {
            icon: <CoachingIcon sx={{ fontSize: 18 }} />,
            iconColor: C.teal,
            iconBg: `${C.teal}12`,
            chip: 'PMP',
            chipColor: C.teal,
            ...
            label: 'Review your Coaching Plan',
        },
    ];
